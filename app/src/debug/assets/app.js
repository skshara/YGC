...
// Back from playlist
const backToMusicPlayer = document.querySelector(".playlists .back-btn");
...
const forwardBtn = document.querySelector('.fas.fa-forward');
const backwardBtn = document.querySelector('.fas.fa-backward');
const playBtn = document.querySelector('.fas.fa-play');
const pauseBtn = document.querySelector('.fas.fa-pause');
const repeatBtn = document.querySelector('.fas.fa-redo');
const volumeBtn = document.querySelector('.fas.fa-volume-up');
...
const setMusic = (i) => {
    ...
    if (isRepeatActive) {
        ...
        music.loop = false; // Disable looping
      }
  };
