...
public class eBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.unitsListView1);
        linearLayout = findViewById(R.id.linearFun1);
        fAuth = FirebaseAuth.getInstance();
        fUser = fAuth.getCurrentUser();
        //loadUrl("file:///android_asset/quiz.html");
        Spinner spinner3 = findViewById(R.id.subjectSpinner1);
        ...
        Spinner spinner1 = findViewById(R.id.gradeSpinner1);
        ...
        submit.setOnClickListener(view -> {
            ...
            documentRef = db.collection("pdf-viewer").document(grade).collection(subject).document("units"); // Replace with your collection name
            documentRef.get().addOnCompleteListener(task -> {
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        ArrayAdapter<String> adapter = new ArrayAdapter<>(eBookActivity.this, android.R.layout.simple_list_item_1, linksList);
    ...
    public void loadUrl(String url) {
        final WebView myWebView = findViewById(R.id.web_pdf);
